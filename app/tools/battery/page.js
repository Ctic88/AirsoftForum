            ...
            <div className="pt-32 px-4 max-w-5xl mx-auto">
                ...
                <header className="mb-12">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-white uppercase tracking-tight">Energy <span className="text-accent-light">Estimation</span></h1>
                            <p className="text-foreground/40 text-sm">Synchronize your battery capacity with operational duration.</p>
                        </div>
                    </div>
                </header>
