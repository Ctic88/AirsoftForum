...
import { Package, Plus, User, Info, Camera, Loader2, Search } from 'lucide-react';
                            ...
                            <div key={kit.id} className="glass rounded-[40px] border border-white/5 overflow-hidden group hover:border-accent-light/30 transition-all flex flex-col">
                                ...
                                <div className="p-8 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                                        ...
                                        <button className="text-[10px] font-bold uppercase tracking-widest text-accent-light hover:underline">Inspect Kit</button>
                                    </div>
                                </div>
                            </div>
                        )) : (
